function aw2018_figure_2(pn_local,pn_common,reProc)
% function aw2018_figure_2(pn_local,pn_common,reProc)
%
...
if reProc==1
    ...
    %% Generate physiology PC data for Figure 2H-I
    clear params
    disp('Performing PCA')
    abrev={'G85','G60','G30','G05','BA','A30','A60','A85',...
        'UDep','AsymDep','AsymCtrl','UCtrl','Ctrl'};
...
display('Finished')
flipSign=0; %Assign custom meaning to relative PC scores, negative = more like depleted
%% Figure 2H-I: Gradual PC1 and PC2 vs TH
